...
let tabList = [...document.getElementsByClassName('petitTextlist')]
console.log(tabList);
//style
...
//evenements
const overlist = (event) => event.target.style.color = 'rgba(255, 255, 255, 0.808)'
const outlist = (event) => event.target.style.color = 'gray'
const overDivGridChild = (event) => event.target.style.backgroundColor = 'hsl(236, 52%, 26%)'
const outDivGridChild = (event) => event.target.style.backgroundColor = 'hsl(236, 45%, 20%)'
