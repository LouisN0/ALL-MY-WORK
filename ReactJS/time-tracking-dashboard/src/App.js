          ...
          <div className='premierBlock'>
            <div className='premierBlockChild' >
              <div className='displayFlex' >
                ...
                <p className='petitText' >Report for</p>
                <h2 className='grandText' >Jeremy<br /> Robson</h2>
              </div>
            </div>
            <div>
              <div className='mMax'>
              <p className='petitText' >Daily</p>
              <p className='petitText' >Weekly</p>
              <p className='petitText' >Monthly</p>
              </div>
            </div>
          </div>
        </div>
